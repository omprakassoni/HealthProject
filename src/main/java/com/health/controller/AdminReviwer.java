...
//		List<Tutorial> pending=tutorialdao.findByVideoAdminRevPending();
//		model.addAttribute("TutorialsPending",pending);
//
//		List<Tutorial> improvement=tutorialdao.findByVideoAdminRevImprovement();
//		model.addAttribute("TutorialsImprovement",improvement);
//
//		List<Tutorial> approved=tutorialdao.findByVideoAdminRevApproved();
//		model.addAttribute("TutorialsApproved",approved);
//
//		List<Tutorial> all=tutorialdao.findByVideoAll();
...
//					Optional<Tutorial> temp=tutorialdao.findById(id);
...
//
//			  videoStatusUpdate.add("Video Status Updated Successfully");
//
...
//
//
//				List<Tutorial> tutorial=tutorialdao.findByVideoStatusByAdmin();
//
//
//
