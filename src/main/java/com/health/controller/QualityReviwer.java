...
//				Optional<Role> temp=RoleRepository.findById(1);
//				Role role= temp.get();
//			 
//			 
...
//		{
//
//		List<Tutorial> tutorial=tutorialdao.findByIdStausForApprove();
//
//		/*
...
//				Tutorial ApproveStatu= temp1.get();
//
//				/*
...
//
//				model.addAttribute("statusVideo","Waiting to be Published");
//
//
//			}
//
...
//			
//			// new version code 2.1.7
//			Optional<Tutorial> temp=tutorialdao.findById(tutorial.getTutorialid());
